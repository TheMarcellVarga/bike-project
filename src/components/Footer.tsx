    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/bikes" className="hover:text-green-400">Bikes</Link></li>
              <li><Link href="/parts" className="hover:text-green-400">Parts</Link></li>
              <li><Link href="/accessories" className="hover:text-green-400">Accessories</Link></li>
              <li><Link href="/about" className="hover:text-green-400">About Us</Link></li>
            </ul>
          </div>

          <div>
            <h4 className="text-white text-md font-semibold mb-4">Customer Service</h4>
            <ul className="space-y-2">
              ...
              <li><Link href="/returns" className="hover:text-green-400">Returns</Link></li>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-sm text-center">
          <p>&copy; {new Date().getFullYear()} Trail Blazer. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
