...
const values = [
  {
    ...
    title: 'Quality First',
    description: 'We carefully select and test every product we sell, ensuring only the best makes it to our customers.'
  },
  {
    icon: <Users className="w-8 h-8 text-green-600" />,
    title: 'Expert Team',
    description: 'Our staff are passionate riders with years of experience in the mountain biking community.'
  },
  {
    icon: <MapPin className="w-8 h-8 text-green-600" />,
    title: 'Trail Tested',
    description: 'Every bike and component is thoroughly tested on real trails before earning our recommendation.'
  },
  {
      ...
      <div className="relative h-[60vh] flex items-center justify-center">
        ...
        <div className="relative z-10 text-center text-white px-4">
          ...
          <p className="text-xl md:text-2xl max-w-3xl mx-auto">
            Founded by riders, for riders. We're here to help you find the perfect gear
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-600 leading-relaxed">
              At Trail Blazer, we believe that every rider deserves access to the best mountain biking
              equipment and expertise. Our mission is to provide premium bikes, parts, and accessories
              while fostering a community of passionate riders who share our love for the trails.
            </p>
          </div>
        </div>
      </section>
