...
const categories = ['All', 'Suspension', 'Drivetrain', 'Brakes', 'Wheels', 'Cockpit']
...
export default function PartsPage() {
  ...
  const filteredParts = parts.filter(part => {
    ...
    if (selectedPriceRange !== 'All') {
      ...
      else if (selectedPriceRange === '$250-$500') matchesPrice = price > 250 && price <= 500
      else if (selectedPriceRange === '$500-$750') matchesPrice = price > 500 && price <= 750
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-green-800 text-white py-16">
        <div className="container mx-auto px-4">
          ...
          <p className="text-lg text-green-100">Premium components to upgrade your ride</p>
        </div>
      </div>
